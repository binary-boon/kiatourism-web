...
export const metadata: Metadata = {
  title: 'Contact Us | Kia Tourism and Hotels',
  description: 'Get in touch with Kia Tourism and Hotels. We\'re here to help you plan your perfect journey.',
}
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-600 leading-relaxed">
              Whether you're planning a luxurious getaway or need assistance with your travel arrangements, 
              our dedicated team at Kia Tourism and Hotels is here to make it happen.
            </p>
          </div>
        </div>
      </section>
              ...
              <div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-100 hover:shadow-xl transition-shadow">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <a href="mailto:admin@kiatourism.com" className="text-blue-600 hover:text-blue-700 block mb-1 text-sm">
                      admin@kiatourism.com
                    </a>
                    <a href="mailto:sales@kiatourism.com" className="text-blue-600 hover:text-blue-700 block text-sm">
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-5xl mx-auto grid md:grid-cols-3 gap-8 text-center">
            ...
            <div>
              ...
              <p className="text-gray-600 text-sm">Your information is safe and confidential</p>
            </div>
            <div>
              ...
              <p className="text-gray-600 text-sm">Dedicated professionals ready to assist you</p>
            </div>
          </div>
        </div>
      </section>
